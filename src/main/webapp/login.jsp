...
<body>
  ...
  <div class="login">
	<h1>Login</h1>
    <form method="post" action="employee/login.html" onsubmit="return check()">
    	<input type="text" name="username" id="username" placeholder="Username" required="required" />
        <input type="password" name="pass" id="pass" placeholder="Password" required="required" />
        <input type="submit" value="登录" class="btn btn-primary btn-block btn-large"/>
        <div style="color: black;">还没有账号?去<a href="register.jsp">注册</a>吧!</div>
    </form>
    <div id="tips">${message}</div>
</div>
